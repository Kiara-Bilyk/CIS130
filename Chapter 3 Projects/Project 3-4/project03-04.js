...
starImages(stars);
// function to add the html and star image for the rating
...
// Loop to set the type of review and add all of the html for the title, reviewer, date reviewed, stars, and the review itself
